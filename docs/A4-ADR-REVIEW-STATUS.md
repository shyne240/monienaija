...
| [ADR-0040 — Policy Versioning and Reproducibility](ADR/ADR-0040-Policy-Versioning-and-Reproducibility.md)                           | Profile/decision/snapshot history is immutable, hash-linked, replayable, append-only, retained, and separate from source/financial truth.                                                 | A4T06 logical contract and A4T07/A4T09 hash, expiry, lineage, replay, and recovery behavior are present.                                                                     | Proposed / logical and runtime alignment | Physical profile/decision/snapshot persistence, repositories, migration evidence, retention schedule, legal holds, and Operations adapter wiring remain unresolved. | Architecture / Operations / Database / Privacy/Legal / Finance  |
...
- [ ] Physical A4T06 persistence and migration design is implemented/reviewed before any durable production activation.

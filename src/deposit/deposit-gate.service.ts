...
import type { DepositGateCommand, DepositGateResult } from './deposit-gate.types';
...
export class DepositGateService {
  ...
  async validate(command: DepositGateCommand): Promise<DepositGateResult> {
    ...
    const evidenceCommand = {
      ...
      evidenceProfile: 'wallet-deposit-create-v1',
